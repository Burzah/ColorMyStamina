...
return {
    ...
    options = {
        widgets = {
            ...
            { setting_id = "color_1",     type = "dropdown", default_value = "red",    options = table.clone(base_colors) },
            { setting_id = "threshold_2", type = "numeric",  default_value = 50,  range = {0, 100} },
            { setting_id = "color_2",     type = "dropdown", default_value = "orange", options = table.clone(base_colors) },
            { setting_id = "threshold_3", type = "numeric",  default_value = 75,  range = {0, 100} },
            { setting_id = "color_3",     type = "dropdown", default_value = "yellow", options = table.clone(base_colors) },
            { setting_id = "threshold_4", type = "numeric",  default_value = 100, range = {0, 100} },
            { setting_id = "color_4",     type = "dropdown", default_value = "green",  options = table.clone(base_colors) },
        }
    }
}